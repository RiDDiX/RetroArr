...
namespace RetroArr.Core.Games
{
    public static class PlatformDefinitions
    {
        ...
        public static readonly List<Platform> AllPlatforms = new()
        {
            ...
            new Platform { Id = 47, Name = "Nintendo Switch 2", Slug = "switch2", FolderName = "switch2", Type = PlatformType.Switch2, Category = "Nintendo", IgdbPlatformId = 441, ParentPlatformId = 46, Enabled = true },
            ...
            new Platform { Id = 128, Name = "CAVE CV1000", Slug = "cave", FolderName = "cave", Type = PlatformType.CAVE, Category = "Arcade", IgdbPlatformId = null, Enabled = false, FolderAliases = new[] { "cave3rd" } },
            ...
            new Platform { Id = 137, Name = "Odyssey² / Videopac", Slug = "o2em", FolderName = "o2em", Type = PlatformType.Odyssey2, Category = "Console", IgdbPlatformId = 133, ScreenScraperSystemId = 104, Enabled = false, FolderAliases = new[] { "odyssey2" } },
            ...
            new Platform { Id = 144, Name = "Casio Loopy", Slug = "casloopy", FolderName = "casloopy", Type = PlatformType.CasioLoopy, Category = "Console", IgdbPlatformId = null, Enabled = false, FolderAliases = new[] { "loopy" } },
            ...
            new Platform { Id = 175, Name = "Dragon 32/64", Slug = "dragon32", FolderName = "dragon32", Type = PlatformType.Dragon32, Category = "Computer", IgdbPlatformId = null, ScreenScraperSystemId = 91, Enabled = false, FolderAliases = new[] { "dragon64" } },
