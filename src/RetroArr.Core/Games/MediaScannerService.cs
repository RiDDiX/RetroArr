...
namespace RetroArr.Core.Games
{
    ...
    public class MediaScannerService
    {
        ...
        private static readonly Dictionary<string, PlatformRule> _platformRules = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            // ========== Microsoft Xbox ==========
            ["xbox"] = new() { Extensions = new[] { ".iso", ".xiso", ".zip", ".7z", ".squashfs" } },
            ["xbox360"] = new() { Extensions = new[] { ".iso", ".xex", ".god", ".zip", ".7z", ".rar", ".xbox360" }, IsFolderMode = true },
            ...
            ["daphne"] = new() { Extensions = new[] { ".daphne", ".zip", ".7z", ".squashfs" }, IsFolderMode = true },
            // ========== Sega (additional) ==========
            ...
            ["jaguarcd"] = new() { Extensions = new[] { ".cue", ".chd", ".bin", ".iso", ".bigpimg", ".cdi" } },
            ...
            ["bbcmicro"] = new() { Extensions = new[] { ".ssd", ".dsd", ".uef", ".zip", ".7z", ".1dd", ".360", ".adf", ".adl", ".adm", ".ads", ".bbc", ".bin", ".cqi", ".cqm", ".d77", ".d88", ".dfi", ".dsk", ".fsd", ".hfe", ".ima", ".imd", ".img", ".ipf", ".mfi", ".mfm", ".tap", ".td0", ".ufi", ".wav" } },
            // ========== Sega (additional) ==========
            ...
            ["triforce"] = new() { Extensions = new[] { ".iso", ".zip", ".7z", ".ciso", ".dol", ".elf", ".gcm", ".gcz", ".m3u", ".wbfs" } },
            ["hikaru"] = new() { Extensions = new[] { ".zip", ".7z" } },
            // ========== Nintendo (additional) ==========
            ["n64dd"] = new() { Extensions = new[] { ".ndd", ".z64", ".n64", ".v64", ".zip", ".7z" } },
            ["satellaview"] = new() { Extensions = new[] { ".sfc", ".smc", ".bs", ".zip", ".7z", ".squashfs" } },
            ["sufami"] = new() { Extensions = new[] { ".sfc", ".smc", ".zip", ".7z", ".bs", ".fig", ".st" } },
            ["sgb"] = new() { Extensions = new[] { ".gb", ".gbc", ".zip", ".7z" } },
            // ========== Atari (additional) ==========
            ["atari800"] = new() { Extensions = new[] { ".xfd", ".atr", ".atx", ".cdm", ".cas", ".bin", ".a52", ".xex", ".zip", ".7z", ".car", ".rom" } },
            ["xegs"] = new() { Extensions = new[] { ".xfd", ".atr", ".atx", ".cdm", ".cas", ".bin", ".a52", ".xex", ".zip", ".7z", ".car", ".dsk", ".rom" } },
            // ========== NEC (additional) ==========
            ["pcfx"] = new() { Extensions = new[] { ".cue", ".chd", ".bin", ".iso", ".7z", ".ccd", ".toc", ".zip" } },
            // ========== Arcade (additional) ==========
            ...
            ["cdi"] = new() { Extensions = new[] { ".cdi", ".chd", ".iso", ".cdr", ".cue", ".gdi", ".nrg", ".toc" } },
            ["channelf"] = new() { Extensions = new[] { ".chf", ".bin", ".zip", ".7z", ".rom" } },
            ["o2em"] = new() { Extensions = new[] { ".bin", ".zip", ".7z" } },
            ["actionmax"] = new() { Extensions = new[] { ".singedata" }, IsFolderMode = true },
            ["adam"] = new() { Extensions = new[] { ".dsk", ".ddp", ".rom", ".col", ".zip", ".7z", ".1dd", ".bin", ".cqi", ".cqm", ".d77", ".d88", ".dfi", ".hfe", ".imd", ".mfi", ".mfm", ".td0", ".wav" } },
            ...
            ["casloopy"] = new() { Extensions = new[] { ".bin", ".zip", ".7z", ".ic1" } },
            ...
            ["amigacdtv"] = new() { Extensions = new[] { ".iso", ".cue", ".chd", ".adf", ".zip", ".7z", ".bin", ".m3u" } },
            ...
            ["amstradcpc"] = new() { Extensions = new[] { ".dsk", ".sna", ".cdt", ".voc", ".kcr", ".m3u", ".zip", ".7z", ".tap" } },
            ["apple2gs"] = new() { Extensions = new[] { ".2mg", ".po", ".dsk", ".do", ".nib", ".woz", ".zip", ".7z", ".dfi", ".edd", ".mfi", ".rti", ".wav" } },
            ["c128"] = new() { Extensions = new[] { ".d64", ".d71", ".d81", ".t64", ".tap", ".crt", ".prg", ".m3u", ".zip", ".7z", ".lnx" } },
            ["cplus4"] = new() { Extensions = new[] { ".d64", ".d81", ".t64", ".tap", ".prg", ".m3u", ".zip", ".7z" } },
            ["pet"] = new() { Extensions = new[] { ".d64", ".d81", ".t64", ".tap", ".prg", ".zip", ".7z", ".a0", ".b0", ".crt", ".m3u" } },
            ["msx2+"] = new() { Extensions = new[] { ".rom", ".mx2", ".dsk", ".cas", ".m3u", ".zip", ".7z" } },
            ["msxturbor"] = new() { Extensions = new[] { ".rom", ".mx2", ".dsk", ".cas", ".m3u", ".zip", ".7z" } },
            ["x1"] = new() { Extensions = new[] { ".dx1", ".2d", ".2hd", ".tfd", ".d88", ".cmd", ".zip", ".7z", ".88d", ".dup", ".hdm", ".xdf" } },
            ["zx81"] = new() { Extensions = new[] { ".p", ".81", ".tzx", ".zip", ".7z" } },
            ["electron"] = new() { Extensions = new[] { ".uef", ".csw", ".ssd", ".dsd", ".zip", ".7z", ".1dd", ".adf", ".adl", ".adm", ".ads", ".bbc", ".bin", ".cqi", ".cqm", ".d77", ".d88", ".dfi", ".dsk", ".hfe", ".imd", ".img", ".mfi", ".mfm", ".rom", ".td0", ".wav" } },
            ["archimedes"] = new() { Extensions = new[] { ".adf", ".jfd", ".zip", ".7z", ".1dd", ".360", ".adl", ".adm", ".ads", ".apd", ".bbc", ".chd", ".cqi", ".cqm", ".d77", ".d88", ".dfi", ".dsd", ".dsk", ".hfe", ".ima", ".imd", ".img", ".ipf", ".mfi", ".mfm", ".msa", ".ssd", ".st", ".td0", ".ufi" } },
            ["atom"] = new() { Extensions = new[] { ".atm", ".tap", ".uef", ".zip", ".7z", ".1dd", ".40t", ".bin", ".cqi", ".cqm", ".csw", ".d77", ".d88", ".dfi", ".dsk", ".hfe", ".imd", ".mfi", ".mfm", ".rom", ".td0", ".wav" } },
            ["aquarius"] = new() { Extensions = new[] { ".bin", ".zip", ".7z" } },
            ["camplynx"] = new() { Extensions = new[] { ".tap", ".zip", ".7z", ".wav" } },
            ["dragon32"] = new() { Extensions = new[] { ".cas", ".ccc", ".rom", ".dsk", ".wav", ".zip", ".7z", ".bin", ".dmk" } },
            ["thomson"] = new() { Extensions = new[] { ".fd", ".sap", ".k7", ".m7", ".m5", ".rom", ".zip", ".7z" } },
            ["ti99"] = new() { Extensions = new[] { ".rpk", ".ctg", ".bin", ".zip", ".7z", ".wav" } },
            ["tutor"] = new() { Extensions = new[] { ".bin", ".zip", ".7z", ".wav" } },
            ["samcoupe"] = new() { Extensions = new[] { ".dsk", ".mgt", ".sbt", ".zip", ".7z", ".cpm", ".sad", ".sdf", ".td0" } },
            ...
            ["fmtowns"] = new() { Extensions = new[] { ".iso", ".cue", ".chd", ".ccd", ".bin", ".zip", ".7z", ".1dd", ".cdr", ".cqi", ".cqm", ".d77", ".d88", ".dfi", ".dsk", ".gdi", ".hfe", ".imd", ".m3u", ".mfi", ".mfm", ".nrg", ".td0", ".toc", ".xdf" } },
            ["fm7"] = new() { Extensions = new[] { ".d77", ".d88", ".t77", ".zip", ".7z", ".1dd", ".cqi", ".cqm", ".dfi", ".dsk", ".hfe", ".imd", ".mfi", ".mfm", ".td0", ".wav" } },
            ["pc88"] = new() { Extensions = new[] { ".d88", ".88d", ".cmt", ".t88", ".zip", ".7z", ".m3u", ".u88" } },
            ["pc98"] = new() { Extensions = new[] { ".fdi", ".hdi", ".hdd", ".d88", ".hdm", ".xdf", ".dup", ".cmd", ".nfd", ".zip", ".7z", ".2hd", ".88d", ".98d", ".d98", ".fdd", ".hdn", ".m3u", ".nhd", ".tfd", ".thd" } },
        ...
        private async Task<int> ScanFileModeAsync(string rootPath, PlatformRule rule, List<Game> existingGames, string platformKey, GameMetadataService metadataService, System.Threading.CancellationToken ct)
        {
            ...
            try
            {
                ...
                // recurse for rom dirs, root only for folder-mode so patches inside a game stay attached
                int maxDepth = rule.IsFolderMode ? 0 : 4;
